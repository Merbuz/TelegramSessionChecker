...
class TSession:
    ...
    async def join_channel(self, invite_link: str) -> None:
        ...
        try:
            if isinstance(await self.client.get_entity(channel_name), Channel):
    ...
    async def start_bot(self, bot_link: str) -> None:
        ...
        try:
            ...
            if isinstance(bot, User) and bot.bot:
                ...
                logging.error('The specified link does not lead to the bot')
                        ...
                        for row in message.reply_markup.rows:  # type: ignore
                            for button in row.buttons:
                                if button_text in button.text:
                                    ...
                                    logging.info(f'Click to \'{button.text}\' button!')  # noqa: E501
